        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EndReason = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CallHistories_Users_ReceiverId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatMessages_ReceiverId_SenderId_Timestamp",
                table: "ChatMessages",
                columns: new[] { "ReceiverId", "SenderId", "Timestamp" });

            migrationBuilder.CreateIndex(
                name: "IX_ChatMessages_SenderId_ReceiverId_Timestamp",
                table: "ChatMessages",
